...
export class PetService {
  ...
  private readonly iniciais: Pet[] = [
    {
      ...
      compatibilidade: ['Famílias', 'Outros cães', 'Passeios diários']
    },
    {
      id: 2,
      nome: 'Luna',
      ...
      imagem: 'img/luna.svg',
      compatibilidade: ['Apartamento', 'Ambiente calmo', 'Tela de proteção']
    },
    {
      id: 3,
      nome: 'Mel',
      ...
      imagem: 'img/mel.svg',
      compatibilidade: ['Casa com espaço', 'Adultos', 'Rotina ativa']
    },
    {
      id: 4,
      nome: 'Nino',
      ...
      imagem: 'img/nino.svg',
      compatibilidade: ['Apartamento', 'Famílias', 'Outros gatos']
    }
  ];
  ...
  adicionar(pet: Omit<Pet, 'id'>): void {
    ...
    localStorage.setItem(this.chave, JSON.stringify(pets));
  }
}
